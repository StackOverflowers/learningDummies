...
//por medio de un bucle for recorro todos los botones de la página
for(let i = 0 ; i<leer.length;i++){
    //Obtengo todos los parrafos a los cuales quiero ocultar, también se manejan en forma de array
    ...
    leer[i].onclick=function (e){
        ...
        }//pero si tiene el estilo block se oculta y cambia el texto del boton
        else{

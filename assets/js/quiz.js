...
let respuestas = [
    ["A. Hyper Text Mask Language", "B. Hard Text Markup Language", "C.  Hyper Text Markup Language ", "D. Hiper Type Markup Language"],
    ["A. background", "B. body", "C. html cuerpo ", "D. heard"],
    ["A. br ", "B. hr", "C. line", "D. wbr"],
    ["A. !--...-- ", "B. ¡--...--! ", "C.  comment", "D.  meta"],
    ["A. img src ", "B. imgage src", "C. background src ", "D. insert image src "],
    ...
    ["A. Una página dinámica ", "B. Un programa PHP ", "C. El código HTML", "D. Las hojas de estilo "],
    ["A. cite", "B. style", "C. link ", "D. file d"],
    ["A. Propiedad", "B. Selector", "C. Variable", "D. Constante"],
    ["A. Biblioteca de herramientas ", "B. Pagina web ", "C. commando de HTML ", "D. Una organizacion "],
    ["A. 4 ", "B. 2 ", "C. 3 ", "D. 1 "],
    ["A. Solo 1 ", "B.  Los que se necesiten ", "C. Maximo 3 ", "D. Ninguno "],
    ["A. Funciones de CSS ", "B. Software de equipo ", "C. Metodogia agil ", "D. Mascara de html "],
    ["A. Hace cumplir todo el ciclo SCRUM, ", "B. Se Encarga de las reuniones ", "C. Apoya a los otros miembros ", "D. Todas las anteriores "]
]
